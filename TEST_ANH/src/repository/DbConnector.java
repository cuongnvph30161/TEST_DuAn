...
public final class DbConnector {
    ...
    private static final String SERVER = "ADMIN-PC\\SQLEXPRESS"; // localhots là ip máy chủ cục bộ hơn , sever : là máy chủ của sql 
    private static final String PORT = "1433";
    private static final String DATABASE_NAME = "TEST_ANH";
